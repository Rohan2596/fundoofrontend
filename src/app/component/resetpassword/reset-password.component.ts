...
export class ResetPasswordComponent implements OnInit {
  ...
  onReset(){
    if(this.resetPassword.newPassword != this.resetPassword.confirmPassword) throw "password are not same"
    if(this.resetPassword.newPassword === ''|| this.resetPassword.confirmPassword ==='') throw "password field empty"
